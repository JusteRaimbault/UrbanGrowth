...
%I am pleased to submit an original research article entitled "Strong coupling between scales in a multi-scalar model of urban dynamics" for consideration for publication in IJGI. This article introduces a novel modeling study on the dynamics of multi-scalar urban systems, with a particular on feedbacks between scales. The subject is in my opinion furthermore particularly suited for the special issue "Spatio-Temporal Models and Geo-Technologies".

%A preliminary version of the methodology and results were presented as a main track talk at the Conference on Complex Systems 2019. A preprint was submitted on arXiv at the same date of this submission (identifier not yet attributed).
