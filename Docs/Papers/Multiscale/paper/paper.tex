...
\author*[1,2,3,4]{\pfx{Dr} \fnm{Juste} \sur{Raimbault} \dgr{PhD}}\email{juste.raimbault@ign.fr}
% orcid 0000-0003-0768-9480
...
\affil[2]{\orgdiv{Center for Advanced Spatial Analysis}, \orgname{University College London}} % , \orgaddress{\street{90 Tottenham Court Road}, \city{London}, \postcode{}, \country{UK}}
...
The Table~\ref{tab:parameters} summarises model parameters. For clarity, we do not include parameters linked to synthetic model setup, and distinguish them by the scale to which they are attached.
% TODO ref table beginning section
