...
% Target: Urban Informatics
% https://www.springer.com/journal/44212/submission-guidelines
% check Response_to_Reviewers submission IJGI
...
% multiscale traffic models (Nancy?) -> ? - not found -> more lit joueiai2014multiscale ok
...
Considering with more details the simulation results we obtained, % TODO bilan des faits importants
