...
montage figuresraw/tmp1.png figuresraw/tmpleg.png -tile 1x2 -geometry +"$HORIZONTALPADDING"+"$VERTICALPADDING" -resize "$WIDTH"x figures/Fig1.jpg
rm figuresraw/tmp1.png figuresraw/tmpleg.png
...
montage figuresraw/tmp2.png figuresraw/tmpleg.png -tile 1x2 -geometry +"$HORIZONTALPADDING"+"$VERTICALPADDING" -resize "$WIDTH"x figures/Fig2.jpg
rm figuresraw/tmp2.png figuresraw/tmpleg.png
