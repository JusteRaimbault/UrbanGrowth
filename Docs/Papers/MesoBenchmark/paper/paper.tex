...
Following the so-called ``first law of geography'', entities in space have interaction patterns which can be described with spatial interaction models, including the gravity model. \cite{li2019singularity}
