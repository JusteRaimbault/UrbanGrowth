...
\sframe{Network interaction model}{
...
\sframe{The Favaro-Pumain model}{
...
Harmonized dataset, explored in particular by \cite{pumain2015multilevel} (built by 
...
\sframe{Results: comparison of models on the different systems}{
...
\sframe{Results: particular cases}{
