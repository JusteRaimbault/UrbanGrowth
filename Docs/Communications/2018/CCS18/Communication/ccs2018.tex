...
% Urban systems are fascinating as they are truly multi-scalar, both in time and space. In particular, they have a very long temporal memory, partly because of the physical artifats : here the Rotunda Galerius which was later a chruch and a Mosque, or the white tower constructed by the ottoman empire ; but also because of non-ergodic dynamics.
