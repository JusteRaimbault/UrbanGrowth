...
% TODO : possibility to begin benchmark stoch cov / interactions here ?
...
% long range correlation patterns
...
% rq : in continuous, equivalent to log-returns
...
% do a minimal shiny app where users can submit their jobs
